<template>
  <div>
    <!-- 整個隱藏 -->
    <div
      id="unit-conversation-rate-modal"
                ...
                >
                  ...
                  >
                    <template slot-scope="scope">
                      <span
                        @click="editUnitConversationRateData(scope.row)"
                  ...
                  >
                    <template slot-scope="scope">
                      <span
                        @click="handleDeleteUnitConversationRate(scope.row)"
...
<script>
import UnitConversationRateForm from './UnitConversationRateChild/UnitConversationRateForm.vue'

export default {
  props: ['visible'],
  components: { UnitConversationRateForm },
  data() {
    return {
  ...
  watch: {
    visible: {
      handler(val) {
        let el = document.getElementById('unit-conversation-rate-modal')
  ...
  methods: {
    ...
    // 關閉視窗
    closeUnitConverastionRateModal() {
